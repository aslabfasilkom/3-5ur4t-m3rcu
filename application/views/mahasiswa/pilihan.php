<section style="background:#efefe9; padding: 30px;">
	<div class="container">
		<div class="row">
			...
			<div class="btn-pref btn-group btn-group-justified btn-group-lg tabmenu" role="group" style="margin-bottom: 30px;">
				<div class="btn-group" role="group">
					<button type="button" id="stars" class="btn btn-success button-skp wow fadeInLeft active-btn" href="#surat-kp" data-toggle="tab">
						<h4>Kerja Praktek</h4>
					</button>
				</div>
				<div class="btn-group" role="group">
						...
						<ul class="timeline">
							...
							<li class="timeline-inverted wow bounceInLeft">
								...
								<div class="timeline-panel" style="background-color: #FFFFFF;">
									...
									<div class="timeline-body">
										Kunjungi link ini untuk mendaftar > 
										<a href="<?php echo site_url('mahasiswa/formkp') ?>" class="btn btn-danger dash-btn">Form Surat KP</a>
										<!-- <?php if ($checkmatkulkp == 0 AND $checktranskripkp ==0 ): ?> -->
										<!-- <?php elseif($checkmatkulkp == 1 AND $checktranskripkp == 0 ): ?> -->
										<!-- <?php elseif($checkmatkulkp == 1 AND $checktranskripkp == 1 ): ?> -->
										<!-- <?php endif ?> -->
