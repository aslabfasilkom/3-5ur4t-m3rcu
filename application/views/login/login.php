<div class="col-md-4 box-login" style="margin-top: 0px; border-radius: 0px;">
  ...
  <?php endif; ?>
  <a href="<?php echo site_url('') ?>"><img class="img-responsive" src="<?php echo base_url('assets/image/logoesurat7v2.png')?>" alt="E-Surat" style="margin-right: auto; margin-left: auto;"></a>
...
<div class="col-md-8 box-login" style="margin-top: 0px; border-radius: 0px; padding-bottom: 36px;">
